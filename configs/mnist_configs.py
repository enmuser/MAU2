...
def configs():
    ...
    parser.add_argument('--pretrained_model', type=str, default='/kaggle/working/MAU2/pretrained_models/mau.ckpt')
    parser.add_argument('--perforamnce_dir', type=str, default='/kaggle/working/MAU2/results/mau/')
    parser.add_argument('--save_dir', type=str, default='/kaggle/working/MAU2/checkpoints/mau/')
    parser.add_argument('--gen_frm_dir', type=str, default='/kaggle/working/MAU2/results/mau/')
